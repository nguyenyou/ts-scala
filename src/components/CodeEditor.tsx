...
import { githubLight } from "./github-light-theme/github-light";
...
function PureCodeEditor({
  ...
  const getLanguageSupport = (
    lang: "markdown" | "java" | "json" | "javascript"
  ): Extension => {
    switch (lang) {
      case "markdown":
        return markdown({
  ...
  return (
    <div
      className="relative not-prose w-full h-full text-sm cursor-text"
      ref={containerRef}
    />
  );
}
